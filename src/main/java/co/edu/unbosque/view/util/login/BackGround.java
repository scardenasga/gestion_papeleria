package co.edu.unbosque.view.util.login;
...
import co.edu.unbosque.view.util.login.utility.FancyBorderRadius;
import co.edu.unbosque.view.util.login.utility.ShadowRenderer;
...
public class BackGround extends JComponent {
    ...
    public void createImage() {
        if (icono != null) {
            ...
            if (width > 0 && height > 0) {
                ...
                Rectangle rec = getAutoSize(icono);

                g2.drawImage(((ImageIcon) icono).getImage(), rec.x, rec.y, rec.width, rec.height, null);
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width,height,"48% 52% 70% 30% / 60% 64% 36% 40%").getShape();
            g2.fill(shape);
            ...
            g2.dispose();
//          Esto se encarga de redondear y agrear una sombra al blur
